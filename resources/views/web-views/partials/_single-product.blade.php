...
<div class="product-card card {{$product['current_stock']==0?'stock-card':''}}">
    {{-- {{ dd($product) }} --}}
    @if($product['current_stock']<=0) <label class="badge badge-danger stock-out">
        ...
        <div class="card-body inline_product text-center p-1 clickable">
            ...
            <h6 class="single-product-review mb-0">
        ...
        {{-- <div class="d-flex justify-content-left w-100"
            style="position: absolute;bottom: 11px;left: 15px;z-index: 2;">
            <div class="flag">
        ...
        <div class="card-body card-body-hidden">
            <div class="text-center">
                ...
                <a class="btn btn-primary btn-sm btn-block mb-2" href="javascript:"
                    ...
                    <i style="font-weight: 900;font-size: 9px; margin-top: -1px;"
                        class="czi-add align-middle {{Session::get('direction') === " rtl" ? 'ml-1' : 'mr-1' }}"></i>
                    Keranjang
                </a>
                @endif
            </div>
